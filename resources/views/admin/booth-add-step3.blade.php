	...
	<div class="card" style="border: 1px solid #dddddd">
		<div class="card-body step">
			<form action="{{ route('admin.add-booth-save') }}" method="POST">
				@csrf
				<small class="mr-3 text-danger" style="float: right;">* Optional</small>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="no-kasir1" name="no_kasir1" value="{{ session('step3')['no_kasir1']}}" onkeypress="return NumberOnly(event)">
				</div>
