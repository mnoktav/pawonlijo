...
<body>
  ...
  <section class="hero-banner pt-4">
    <div class="container">
      <div class="jumbotron rounded-0">
        <div class="row pb-4 pb-4" style="padding-left: 6%;">
          <div class="col-md-1 offset-md-3">
            <img class="img-responsive w-100" src="{{ asset('assets/img/undip.png') }}" alt="">
          </div>
          <div class="col-md-5 mt-3">
            <h5 style="margin: 0;">Teknik Komputer, Fakultas Teknik</h5>
            <h5 style="margin: 0;">Universitas Diponegoro Semarang</h5>
          </div>
          <div class="col-md-9 offset-md-1 pt-4" style="border-bottom: 1px solid grey;">
        ...
        <div class="row">
          <div class="col-md-8 offset-md-2 text-center">
            <h4 class="pb-3 pt-3">
              Perancangan Sistem Informasi Monitoring Penjualan
              Berbasis Website Dengan Menggunakan Kerangka Kerja Laravel
              Pada Kedai Makanan Pawon Lijo 
            </h4>
            <h6 class="pb-3">Oleh : </h6>
            <h5 class="pb-4">
              M. Nuril Oktavian <br>
              21120115130064
            </h5>

            <a href="{{ url('/lp') }}" class="btn btn-primary btn-lg">Next</a>
          </div>
        </div>
      </div>
    </div>
