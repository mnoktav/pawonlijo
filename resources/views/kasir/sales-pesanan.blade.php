...
@section('content')
	<div class="page-inner">
		<div class="card">
			<div class="card-body">
				<h4 style="text-transform: uppercase;"><b>PESANAN {{session('login')['nama_booth']}}</b></h4>
					...
					<table id="basic-datatables" class="display table table-striped" style="padding: 0px;">
						...
						<tbody>
							...
							<tr>
								...
								@endif
								<td>
									<a href="{{ route('kasir.transaksi-detail-pesanan',$sale->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-info"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
